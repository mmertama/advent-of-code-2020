...
if __name__ == "__main__":
    tasks = {'1_1': find_two_factors,
             '1_2': find_three_factors}
    # find_two_factors(read_local_lines(example1))
    # find_two_factors(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input.txt'))
    # find_three_factors(read_local_lines(example1))
    # find_three_factors(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input.txt'))
    # validate_passwords(read_local_lines(example2))
    # validate_passwords(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input2.txt'))
    # validate_passwords_2(read_local_lines(example2))
    # validate_passwords_2(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input2.txt'))
    # navigate_thru_trees(3, 1, read_local_lines(example3))
    # navigate_thru_trees(3, 1, read_remote_lines('C:\\Users\\intopalo\\Downloads\\input3.txt'))
    # navigate_thru_trees2(read_local_lines(example3))
    # navigate_thru_trees2(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input3.txt'))
    # check_passports_loose(read_local_lines(example4))
    # check_passports_loose(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input4.txt'))
    ...
    check_passports_strict(read_remote_lines('C:\\Users\\intopalo\\Downloads\\input4.txt'))